 ...
 * wird durch den Spielernamen ersetzt (z.B. für Economy-Plugins, Ränge usw.).
 */
public class CrateReward {

    public enum Type { ITEM, COMMAND }
    ...
    public CrateReward(String id, Type type, String displayName, int weight, String category,
                        Material material, int amount, String command) {
        this.id = id;
        this.type = type;
    ...
    public static CrateReward item(String id, String displayName, int weight, String category, Material material, int amount) {
        return new CrateReward(id, Type.ITEM, displayName, weight, category, material, amount, null);
    }

    public static CrateReward command(String id, String displayName, int weight, String category, String command) {
        return new CrateReward(id, Type.COMMAND, displayName, weight, category, null, 0, command);
    }
